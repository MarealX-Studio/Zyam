...
export function SettingAbout({id, icon}: {id: string, icon?: React.ReactNode}) {
  ...
  const items = [
    ...
    {
      url: "https://zyam.top/en/settings/sync.html",
    ...
    {
      url: "https://github.com/MarealX-Studio/Zyam",
    ...
    {
      url: "https://github.com/MarealX-Studio/Zyam/releases",
    ...
    {
      url: "https://github.com/MarealX-Studio/Zyam/issues",
    ...
    {
      url: "https://github.com/MarealX-Studio/Zyam/discussions",
