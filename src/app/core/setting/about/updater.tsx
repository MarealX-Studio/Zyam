...
export default function Updater() {
    ...
    function openRelease() {
      open('https://github.com/MarealX-Studio/Zyam/releases');
    }
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between w-full lg:items-center gap-4 lg:gap-0">
          <div className="flex items-center gap-4">
            ...
            <div className="h-24 flex-1 flex flex-col justify-between">
              <span className="text-xl lg:text-2xl font-bold flex items-center gap-2">Zyam</span>
          ...
          update && latestBody ? (
            <div className="mt-8 p-4 border rounded-md">
              <div className="flex items-center gap-2 justify-between mb-4">
                <h1 className="text-lg font-bold">Zyam v{update.version}</h1>
